  ...
  return (
    <div className="tableWithPagination">
      ...
      >
        ...
        <td><input type="checkbox"/>{" "}456787654</td>
                {row.cells.map((cell) => {
                  return (
      ...
      >
        ...
        <tbody {...getTableBodyProps()}>
          {page.map((row, i) => {
            ...
            return (
              <tr {...row.getRowProps()}>
                 <td className="text-center"><input type="checkbox"/>{"   "}<span>5134526</span></td>
                {row.cells.map((cell) => {
                  return (
                    <td {...cell.getCellProps()}>{cell.render("Cell")}</td>
                  );
        ...
        <div className="wrapperInner">
          ...
          <div className="documentsTable pageTableMain pageTableContainer">
            ...
            <div className="pageTableTabs">
              ...
              <div>
                <button className="digital-sign-btn">Bulk Digital Sign</button>
              </div>
              </div>
