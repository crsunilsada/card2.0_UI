...
import { Row, Col, Tab, Nav, Form, Modal } from "react-bootstrap";
...
<Modal show={show} onHide={handleClose} className="modal modal-xl">
          ...
          <Modal.Footer>
            <div className="pageNextBtn">
              ...
              <button className="next mb-2 m-1" onClick={handleClose}>
                Done
              </button>
            </div>
          </Modal.Footer>
 ...
 <Modal show={show1} onHide={handleClose1} className="modal modal-xl">
          ...
          <Modal.Footer>
            <div className="pageNextBtn">
              ...
              <button className="next mb-2 m-1" onClick={handleClose1}>
                Done
              </button>
            </div>
          </Modal.Footer>
 ...
 <Modal show={show2} onHide={handleClose2} className="modal modal-xl">
          ...
          <Modal.Footer>
            <div className="pageNextBtn">
              ...
              <button className="next mb-2 m-1" onClick={handleClose2}>
                Done
              </button>
            </div>
          </Modal.Footer>
