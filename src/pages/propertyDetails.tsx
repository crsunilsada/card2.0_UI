...
const PropertyDetails = () => {
    ...
    function handleButtonClick2() {
        if (cards2.length === 0) {
            const newCard2 = { title: "New", description: "newcard." };
            setCards2([newCard2, ...cards2]);
        }
    ...
    function handleButtonClick4() {
        if (cards4.length === 0) {
            const newCard4 = { title: "New", description: "newcard." };
            setCards4([newCard4, ...cards4]);
        }
                                                                ...
                                                                <div>
                                                                    ...
                                                                    {!buttonClicked2 && (
                                                                        <div>
                                                                            ...
                                                                            <div className="pageNextBtn">
                                                                                <button className="clear" onClick={handleButtonClick2}>Add new</button>
                                                                                <button className="next">Next</button>
                                                                            </div>
                                                                        </div>
                                                                    )}
                                                ...
                                                <Accordion>
                                                    <Accordion.Item eventKey="0">
                                                        ...
                                                        {!display4 && <Accordion.Body>
                                                            ...
                                                            <h4>Rent Details</h4>
                                                            {
                                                                inputFields1.map((data1, index1) => {
                                                                    const { fullName1 } = data1;
                                                                    return (
                                                                        <Row className="mb-4" key={index1}>
                                                                            <Col lg={3} md={3} xs={12} className="mb-3">
                                                                                <Form.Floating>
                                                                                    <Form.Control defaultValue="12 Months"
                                                                                        id="floatingInputCustom"
                                                                            ...
                                                                            <Col lg={3} md={3} xs={12} className="mb-3">
                                                                                <Form.Floating>
                                                                                    <Form.Control defaultValue="15000" name="fullName1"
                                                                                        id="floatingInputCustom"
                                                                                        type="text"
                                                                                        placeholder="Rent Amount" />
                                                                                    <Form.Label htmlFor="floatingInputCustom">
                                                                            ...
                                                                            <Col lg={3} md={3} xs={12} className="mb-3">
                                                                                <Form.Floating>
                                                                                    <Form.Select aria-label="units" name="fullName1" id="floatingInputCustom" placeholder="Monthly/ Yearly">
                                                                                    <option value="0">Please Select</option>
                                                                                        <option value="1" selected>One</option>
                                                                                        <option value="2">Two</option>
                                                                                        <option value="3">Three</option>
                                                                            ...
                                                                            <Col lg={1} md={1} xs={12} className="col-sm-*">
                                                                                {
                                                                                    index1 === inputFields1.length - 1 ?
                                                                                        (
                                                                                            <div className="pageNextBtn" style={{ padding: 0 }}>
                                                                                                <button onClick={addInputField1} style={{ background: "#274c77", width: "10px", justifyContent: "center", color: "white" }}><span className="d-flex justify-content-center mx-auto"><strong>+</strong></span></button>
                                                                                            </div>
                                                                                        )
                                                                                        :
                                                                                        (""
                                                            ...
                                                            <div className="pageNextBtn">
                                                                <button className="clear">Clear</button>
                                                                <button className="next" onClick={handleClick4}>Next</button>
                                                            </div>
                                                        </Accordion.Body>}
                                                        {display4 && <Accordion.Body>
                                                            <div className="linkdocuments-bg">
                                                ...
                                                <Accordion>
                                                    <Accordion.Item eventKey="0">
                                                        ...
                                                        {!display5 && <Accordion.Body >
                                                            ...
                                                            <div className="pageNextBtn">
                                                                <button className="clear">Cancel</button>
                                                                <button onClick={handleClick5} className="next">Done</button>
                                                            </div>
                                                        </Accordion.Body>}
                                                        {display5 && <Accordion.Body>
                                                            <div className="linkdocuments-bg">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    {!buttonClicked4 && (
                                                                        <div>
                                                                            ...
                                                                            <div className="pageNextBtn">
                                                                                <button className="clear" onClick={handleButtonClick4}>Add new</button>
                                                                                <button className="next">Next</button>
                                                                            </div>
                                                                        </div>
                                                                    )}
                                                ...
                                                <Accordion>
                                                    <Accordion.Item eventKey="0">
                                                        ...
                                                        {!display6 && <Accordion.Body>
                                                            ...
                                                            <div className="pageNextBtn">
                                                                <button className="clear">clear</button>
                                                                <button className="next" onClick={handleClick6}>Next</button>
                                                            </div>
                                                        </Accordion.Body>}
                                                        {display6 && <Accordion.Body>
                                                            <div className="linkdocuments-bg">
                                                ...
                                                <Accordion>
                                                    <Accordion.Item eventKey="0">
                                                        ...
                                                        {!display7 && <Accordion.Body>
                                                            ...
                                                            <h4>Rent Details</h4>
                                                            {
                                                                inputFields2.map((data2, index2) => {
                                                                    const { fullName2 } = data2;
                                                                    return (
                                                                        <Row className="mb-4" key={index2}>
                                                                            <Col lg={3} md={3} xs={12} className="mb-3">
                                                                                <Form.Floating>
                                                                                    <Form.Control defaultValue="12 Months"
                                                                                        id="floatingInputCustom"
                                                                            ...
                                                                            <Col lg={3} md={3} xs={12} className="mb-3">
                                                                                <Form.Floating>
                                                                                    <Form.Control defaultValue="15000" name="fullName2"
                                                                                        id="floatingInputCustom"
                                                                                        type="text"
                                                                                        placeholder="Rent Amount" />
                                                                                    <Form.Label htmlFor="floatingInputCustom">
                                                                            ...
                                                                            <Col lg={3} md={3} xs={12} className="mb-3">
                                                                                <Form.Floating>
                                                                                    <Form.Select aria-label="units" name="fullName2" id="floatingInputCustom" placeholder="Monthly/ Yearly">
                                                                                    <option value="0">Please Select</option>
                                                                                        <option value="1" selected>One</option>
                                                                                        <option value="2">Two</option>
                                                                                        <option value="3">Three</option>
                                                                            ...
                                                                            <Col lg={1} md={1} xs={12} className="col-sm-*">
                                                                                {
                                                                                    index2 === inputFields2.length - 1 ?
                                                                                        (
                                                                                            <div className="pageNextBtn" style={{ padding: 0 }}>
                                                                                                <button onClick={addInputField2} style={{ background: "#274c77", width: "10px", justifyContent: "center", color: "white" }}><span className="d-flex justify-content-center mx-auto"><strong>+</strong></span></button>
                                                                                            </div>
                                                                                        )
                                                                                        :
                                                                                        (""
                                                            ...
                                                            <div className="pageNextBtn">
                                                                <button className="clear">Clear</button>
                                                                <button className="next" onClick={handleClick7}>Next</button>
                                                            </div>
                                                        </Accordion.Body>}
                                                        {display7 && <Accordion.Body>
                                                            <div className="linkdocuments-bg">
                                                ...
                                                <Accordion>
                                                    <Accordion.Item eventKey="0">
                                                        ...
                                                        {!display8 && <Accordion.Body >
                                                            ...
                                                            <div className="pageNextBtn">
                                                                <button className="clear">Cancel</button>
                                                                <button onClick={handleClick8} className="next">Done</button>
                                                            </div>
                                                        </Accordion.Body>}
                                                        {display8 && <Accordion.Body>
                                                            <div className="linkdocuments-bg">
